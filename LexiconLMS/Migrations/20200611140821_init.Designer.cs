            ...
            modelBuilder.Entity("LexiconLMS.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Kurs1",
                            StartDate = new DateTime(2020, 6, 11, 16, 8, 20, 750, DateTimeKind.Local).AddTicks(8334)
                        });
                });
            ...
            modelBuilder.Entity("LexiconLMS.Models.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2020, 6, 11, 16, 8, 20, 754, DateTimeKind.Local).AddTicks(1053),
                            Name = "Module1",
                            StartDate = new DateTime(2020, 6, 11, 16, 8, 20, 754, DateTimeKind.Local).AddTicks(438)
                        });
                });
            ...
            modelBuilder.Entity("LexiconLMS.Models.Task", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndDate = new DateTime(2020, 6, 11, 16, 8, 20, 754, DateTimeKind.Local).AddTicks(4779),
                            ModuleId = 1,
                            Name = "Model1",
                            StartDate = new DateTime(2020, 6, 11, 16, 8, 20, 754, DateTimeKind.Local).AddTicks(4160),
                            TaskTypeId = 1
                        });
                });
